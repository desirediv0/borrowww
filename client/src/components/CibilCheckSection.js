...
export default function CibilCheckSection() {
  ...
  return (
    <section id="cibil-check" className="py-20 bg-gradient-to-br from-gray-50 via-white to-blue-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            Get your credit score instantly and understand your creditworthiness. 
            Free CIBIL score check with detailed credit report analysis.
          </motion.p>
        </motion.div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="p-4 border-2 border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 rounded-xl bg-gray-50 placeholder:text-gray-400 transition-all duration-200"
                      required
                    />
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="panNumber" className="text-base font-semibold text-gray-700 flex items-center gap-2">
                      <motion.div
                        whileHover={{ scale: 1.2 }}
                        transition={{ type: "spring", stiffness: 400 }}
                      >
                    ...
                    <Input
                      ...
                      className="p-4 border-2 border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 rounded-xl bg-gray-50 placeholder:text-gray-400 transition-all duration-200 uppercase tracking-widest"
                      required
                      maxLength={10}
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="aadhaarNumber" className="text-base font-semibold text-gray-700 flex items-center gap-2">
                      <motion.div
                        whileHover={{ scale: 1.2 }}
                        transition={{ type: "spring", stiffness: 400 }}
                      >
                    ...
                    <Input
                      ...
                      className="p-4 border-2 border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 rounded-xl bg-gray-50 placeholder:text-gray-400 transition-all duration-200 tracking-widest"
                      required
                      maxLength={14}
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="mobileNumber" className="text-base font-semibold text-gray-700 flex items-center gap-2">
                      <motion.div
                        whileHover={{ scale: 1.2 }}
                        transition={{ type: "spring", stiffness: 400 }}
                      >
                  ...
                  >
                    <Button
                      type="submit"
                      className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white py-4 text-lg font-bold rounded-xl shadow-lg transform hover:scale-105 transition-all duration-300 focus:ring-2 focus:ring-blue-300 focus:outline-none"
                    >
            ...
            >
              <div className="grid grid-cols-3 gap-4 text-center">
                {[
                  ...
                  >
                    <motion.div 
                      className="text-2xl font-bold text-blue-600 mb-1 flex items-center justify-center gap-1"
                      animate={{ 
                        y: [0, -2, 0]
                      }}
                      transition={{ 
